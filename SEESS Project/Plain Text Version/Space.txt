 ...
 * your ship. 
 * 
 * Upgrade your ship and fight through the onslaught of enemy ships to get a high score. (And level your ship to become awesome)
 * 
 * 
 * Forms: 
 * Fire  -- 
 ...
 *  Wind Blade Count - Up to three simultaneous projectiles
...
public class Space extends Game {
   ...
   @Override
    public void create() {
	   ...
	   upgradeSelectionImg = new Texture(Gdx.files.internal("upgradeSelector.png"));
